...
public class StructureComponentVillageWoodHut extends StructureComponentVillage {
    ...
    public static StructureComponentVillageWoodHut func_74908_a(
            StructureComponentVillageStartPiece par0ComponentVillageStartPiece,
            List<StructureComponent> par1List,
            Random par2Random,
            int par3,
            int par4,
            int par5,
        ...
        final StructureBoundingBox var8 =
                StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 17, 9, 17, par6);
        return StructureComponent.findIntersecting(par1List, var8) == null
                ? new StructureComponentVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
                : null;
    }
    ...
    public boolean addComponentParts(
        ...
        for (yLevel = -8; yLevel < 4; yLevel++) {
            ...
            this.placeBlockAtCurrentPosition(
                    par1World,
                    yLevel <= 1 ? GCBlocks.basicBlock : Blocks.air,
                    4,
                    1,
                    yLevel,
                    8,
            ...
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 1, yLevel, 10, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 1, yLevel, 11, par3StructureBoundingBox);

            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 2, yLevel, 12, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 2, yLevel, 13, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 3, yLevel, 14, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 4, yLevel, 14, par3StructureBoundingBox);

            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 5, yLevel, 15, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 6, yLevel, 15, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 7, yLevel, 15, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World,
                    yLevel <= 1 ? GCBlocks.basicBlock : Blocks.air,
                    4,
                    ...
                    par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 9, yLevel, 15, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 10, yLevel, 15, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 11, yLevel, 15, par3StructureBoundingBox);

            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 12, yLevel, 14, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 13, yLevel, 14, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 14, yLevel, 13, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 14, yLevel, 12, par3StructureBoundingBox);

            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 15, yLevel, 11, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 15, yLevel, 10, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 15, yLevel, 9, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World,
                    yLevel <= 1 ? GCBlocks.basicBlock : Blocks.air,
                    4,
                    ...
                    par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 15, yLevel, 7, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 15, yLevel, 6, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 15, yLevel, 5, par3StructureBoundingBox);

            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 14, yLevel, 4, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 14, yLevel, 3, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 13, yLevel, 2, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 12, yLevel, 2, par3StructureBoundingBox);

            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 11, yLevel, 1, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(
                    par1World, GCBlocks.basicBlock, 4, 10, yLevel, 1, par3StructureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(
                par1World, GCBlocks.glowstoneTorch, 0, 14, yLevel, 8, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(
                par1World, GCBlocks.glowstoneTorch, 0, 8, yLevel, 14, par3StructureBoundingBox);
            ...
            for (int j = 5; j <= 11; j++) {
                if (!(j == 5 && i == 5 || j == 5 && i == 11 || j == 11 && i == 5 || j == 11 && i == 11)) {
                    if (i >= 7 && i <= 9 && j >= 7 && j <= 9) {
                        ...
                        this.placeBlockAtCurrentPosition(
                                par1World, GCBlocks.basicBlock, 4, i, yLevel, j, par3StructureBoundingBox);
                    }
                }
            }
        }

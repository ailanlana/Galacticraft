...
public class StructureVillageStartMoon extends StructureStart {
    ...
    public StructureVillageStartMoon(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightMoon> var6 =
                StructureVillagePiecesMoon.getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentVillageStartPiece var7 = new StructureComponentVillageStartPiece(
                par1World.getWorldChunkManager(), 0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2, var6, par5);

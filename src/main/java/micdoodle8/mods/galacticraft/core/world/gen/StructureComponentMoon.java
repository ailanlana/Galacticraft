...
public abstract class StructureComponentMoon extends StructureComponent {
    ...
    public static StructureBoundingBox getComponentToAddBoundingBox(
        ...
        switch (var9) {
            ...
            case 3:
                return new StructureBoundingBox(
                        var0 + var5, var1 + var4, var2 - var6, var0 + var8 + var5, var1 + var7 + var4, var2 + var3);
    ...
    protected TileEntityMobSpawner placeSpawnerAtCurrentPosition(
            World var1, Random var2, int var3, int var4, int var5, String var6, StructureBoundingBox var7) {
    ...
    protected int[] offsetTowerCoords(int var1, int var2, int var3, int var4, int var5) {
        ...
        return var5 == 0
                ? new int[] {var6 + 1, var7 - 1, var8 - var4 / 2}
                : var5 == 1
                        ? new int[] {var6 + var4 / 2, var7 - 1, var8 + 1}
                        : var5 == 2
                                ? new int[] {var6 - 1, var7 - 1, var8 + var4 / 2}
                                : var5 == 3
                                        ? new int[] {var6 - var4 / 2, var7 - 1, var8 - 1}
    ...
    protected void placeBlockAtCurrentPosition(
            World var1, Block var2, int var3, int var4, int var5, int var6, StructureBoundingBox var7) {
        super.placeBlockAtCurrentPosition(var1, var2, var3, var4, var5, var6, var7);
    }

    protected void placeBlockRotated(
            World var1, Block var2, int var3, int var4, int var5, int var6, int var7, StructureBoundingBox var8) {
    ...
    protected void fillBlocksRotated(
            World var1,
    ...
    public void nullifySkyLightAtCurrentPosition(
            World var1, int var2, int var3, int var4, int var5, int var6, int var7) {
        this.nullifySkyLight(
                var1,

...
public class StructureVillagePiecesMoon {
    ...
    private static int func_75079_a(List<StructureVillagePieceWeightMoon> par0List) {
        ...
        for (final Iterator<StructureVillagePieceWeightMoon> var3 = par0List.iterator();
                var3.hasNext();
    ...
    private static StructureComponentVillage func_75083_a(
            ...
            StructureVillagePieceWeightMoon par1StructureVillagePieceWeight,
            List<StructureComponent> par2List,
            Random par3Random,
            int par4,
            int par5,
            int par6,
        ...
        if (var9 == StructureComponentVillageWoodHut.class) {
            var10 = StructureComponentVillageWoodHut.func_74908_a(
                    par0ComponentVillageStartPiece, par2List, par3Random, par4, par5, par6, par7, par8);
        } else if (var9 == StructureComponentVillageField.class) {
            var10 = StructureComponentVillageField.func_74900_a(
                    par0ComponentVillageStartPiece, par2List, par3Random, par4, par5, par6, par7, par8);
        } else if (var9 == StructureComponentVillageField2.class) {
            var10 = StructureComponentVillageField2.func_74900_a(
                    par0ComponentVillageStartPiece, par2List, par3Random, par4, par5, par6, par7, par8);
        } else if (var9 == StructureComponentVillageHouse.class) {
            var10 = StructureComponentVillageHouse.func_74921_a(
                    par0ComponentVillageStartPiece, par2List, par3Random, par4, par5, par6, par7, par8);
        }
    ...
    private static StructureComponentVillage getNextVillageComponent(
            ...
            int par6,
            int par7) {
        final int var8 = StructureVillagePiecesMoon.func_75079_a(
        ...
        if (var8 <= 0) {
            ...
            while (var9 < 5) {
                ...
                final Iterator<StructureVillagePieceWeightMoon> var11 =
            ...
            final StructureBoundingBox var14 = StructureComponentVillageTorch.func_74904_a(
                    par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6);

            if (var14 != null) {
                return new StructureComponentVillageTorch(
                        par0ComponentVillageStartPiece, par7, par2Random, var14, par6);
            } else {
                return null;
            }
        }
    ...
    static StructureComponent getNextStructureComponent(
        ...
        return StructureVillagePiecesMoon.getNextVillageStructureComponent(
                par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6, par7);
    }

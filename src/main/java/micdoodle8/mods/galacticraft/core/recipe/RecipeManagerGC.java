...
public class RecipeManagerGC {
    ...
    private static void addUniversalRecipes() {
         ...
         * ItemStack(GCItems.heavyPlatingTier1)); input.put(4, new
         * ItemStack(GCItems.heavyPlatingTier1)); input.put(5, new
         * ItemStack(GCItems.heavyPlatingTier1)); input.put(6, new
         * ItemStack(GCItems.heavyPlatingTier1)); input.put(7, new
         * ItemStack(GCItems.heavyPlatingTier1)); input.put(8, new
         * ItemStack(GCItems.heavyPlatingTier1)); input.put(9, new
         * ItemStack(GCItems.heavyPlatingTier1)); input.put(10, new
         * ItemStack(GCItems.partFins)); input.put(11, new ItemStack(GCItems.partFins));
         * input.put(12, new ItemStack(GCItems.rocketEngine)); input.put(13, new
         * ItemStack(GCItems.partFins)); input.put(14, new ItemStack(GCItems.partFins));
         * input.put(15, null); input.put(16, null); input.put(17, null);
         * RecipeUtil.addRocketBenchRecipe(new ItemStack(GCItems.rocketTier1, 1, 0),
         * input);
         */
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.aluminumWire, 1, 1), new Object[] {
            "X", "Y", "Z", 'X', Blocks.wool, 'Y', new ItemStack(GCBlocks.aluminumWire, 1), 'Z', "ingotAluminum"
        });

        RecipeUtil.addRecipe(new ItemStack(GCBlocks.aluminumWire, 1, 1), new Object[] {
            "Z", "Y", "X", 'X', Blocks.wool, 'Y', new ItemStack(GCBlocks.aluminumWire, 1), 'Z', "ingotAluminum"
        });
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.machineTiered, 1, 0), new Object[] {
            "SSS",
            "BBB",
            "SSS",
            'B',
        ...
        if (GalacticraftCore.isPlanetsLoaded) {
            ...
            RecipeUtil.addRecipe(new ItemStack(GCBlocks.machineTiered, 1, 8), new Object[] {
                "BSB",
                "SWS",
                "BSB",
                'B',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.machineBase2, 1, 8), new Object[] {
            "SSS",
            "BBB",
            "SSS",
            'B',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCItems.sensorGlasses, 1), new Object[] {
            "ZWZ", "Z Z", "XYX", 'W', Items.diamond, 'X', GCItems.sensorLens, 'Y', meteoricIronIngot, 'Z', Items.string
        });

        RecipeUtil.addRecipe(new ItemStack(GCItems.sensorLens, 1), new Object[] {
            "ZXZ", "XYX", "ZXZ", 'X', Blocks.glass_pane, 'Y', meteoricIronPlate, 'Z', Items.redstone
        });
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.sealableBlock, 1, 14), new Object[] {
            "XYX", 'Y', new ItemStack(GCBlocks.aluminumWire, 1, 0), 'X', new ItemStack(GCBlocks.basicBlock, 1, 4)
        });

        RecipeUtil.addRecipe(new ItemStack(GCBlocks.sealableBlock, 1, 15), new Object[] {
            "XYX", 'Y', new ItemStack(GCBlocks.aluminumWire, 1, 1), 'X', new ItemStack(GCBlocks.basicBlock, 1, 4)
        });
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.oxygenDetector, 1), new Object[] {
            "WWW",
            "YVY",
            "ZUZ",
            'U',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.oxygenDistributor, 1), new Object[] {
            "WXW",
            "YZY",
            "WXW",
            'W',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.oxygenSealer, 1), new Object[] {
            "UZU",
            "YXY",
            "UZU",
            'U',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.oxygenCollector, 1), new Object[] {
            "WWW",
            "YXZ",
            "UVU",
            'U',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.airLockFrame, 1, 1), new Object[] {
            "YYY",
            "WZW",
            "YYY",
            'W',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.oxygenCompressor, 1, 0), new Object[] {
            "XWX",
            "WZW",
            "XYX",
            'W',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.oxygenCompressor, 1, 4), new Object[] {
            "XVX",
            "WZW",
            "XYX",
            'V',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.fuelLoader), new Object[] {
            "XXX",
            "XZX",
            "WYW",
            'W',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCItems.basicItem, 1, 1), new Object[] {
            "XXX",
            "YYY",
            "XXX",
            'X',
            new ItemStack(GCItems.basicItem, 1, 0),
            'Y',
            new ItemStack(GCBlocks.aluminumWire, 1, 0)
        });

        RecipeUtil.addRecipe(new ItemStack(GCBlocks.solarPanel, 1, 0), new Object[] {
            "XYX",
            "XZX",
            "VWV",
            'V',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.solarPanel, 1, 4), new Object[] {
            "XYX",
            "XZX",
            "VWV",
            'V',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.cargoLoader, 1, 0), new Object[] {
            "XWX",
            "YZY",
            "XXX",
            'W',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.cargoLoader, 1, 4), new Object[] {
            "XXX",
            "YZY",
            "XWX",
            'W',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.spinThruster), new Object[] {
            "   ",
            "YWZ",
            "PXP",
            'W',
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.telemetry), new Object[] {
            "XFX",
            "XWX",
            "YYY",
            'W',

...
public class ContainerSchematicTier1Rocket extends Container {
    ...
    public ContainerSchematicTier1Rocket(InventoryPlayer par1InventoryPlayer, int x, int y, int z) {
        ...
        this.addSlotToContainer(
                new SlotRocketBench(this.craftMatrix, 1, 48, -8 + change, x, y, z, par1InventoryPlayer.player));
        ...
        // Left fins
        this.addSlotToContainer(
                new SlotRocketBench(this.craftMatrix, 10, 21, 64 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(
                new SlotRocketBench(this.craftMatrix, 11, 21, 82 + change, x, y, z, par1InventoryPlayer.player));

        // Engine
        this.addSlotToContainer(
                new SlotRocketBench(this.craftMatrix, 12, 48, 82 + change, x, y, z, par1InventoryPlayer.player));

        // Right fins
        this.addSlotToContainer(
                new SlotRocketBench(this.craftMatrix, 13, 75, 64 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(
                new SlotRocketBench(this.craftMatrix, 14, 75, 82 + change, x, y, z, par1InventoryPlayer.player));
        ...
        for (var6 = 0; var6 < 3; ++var6) {
            for (var7 = 0; var7 < 9; ++var7) {
                this.addSlotToContainer(
                        new Slot(par1InventoryPlayer, var7 + var6 * 9 + 9, 8 + var7 * 18, 111 + var6 * 18 + change));
            }
        }

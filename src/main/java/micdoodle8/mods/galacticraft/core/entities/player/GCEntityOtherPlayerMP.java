...
public class GCEntityOtherPlayerMP extends EntityOtherPlayerMP {
    ...
    //        boolean b = this.galacticraftCapeImageData != null && this.galacticraftCapeImageData.getGlTextureId() !=
    // -1;
    //
    ...
    //			this.galacticraftCapeImageData = GCEntityOtherPlayerMP.getDownloadImage(this.galacticraftCape,
    // EntityClientPlayerMP.getCapeURL(this.getGameProfile().getName()));
    //		}
    //	}
    //
    ...
    //	{
    //		if ((ConfigManagerCore.overrideCapes || !super.getTextureCape().isTextureUploaded()) && this.galacticraftCape !=
    // null)
    //		{

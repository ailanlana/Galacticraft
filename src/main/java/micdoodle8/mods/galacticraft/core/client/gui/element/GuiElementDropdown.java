    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3) {
        ...
        if (this.visible) {
            ...
            Gui.drawRect(
                    ...
                    this.yPosition + (this.dropdownClicked ? this.height * this.optionStrings.length : this.height),
                    ColorUtil.to32BitColor(255, 200, 200, 200));
            Gui.drawRect(
                    this.xPosition + 1,
                    this.yPosition + 1,
            ...
            if (this.dropdownClicked
                ...
                Gui.drawRect(
                        ...
                        this.xPosition + this.width - 1,
                        this.yPosition + this.height * (hoverPos + 1) - 1,
            ...
            if (this.dropdownClicked) {
                for (int i = 0; i < this.optionStrings.length; i++) {
                    this.font.drawStringWithShadow(
                            this.optionStrings[i],
                            this.xPosition + this.width / 2 - this.font.getStringWidth(this.optionStrings[i]) / 2,
                            this.yPosition + (this.height - 8) / 2 + this.height * i,

...
public class GuiOxygenCompressor extends GuiContainerGC {
    ...
    public GuiOxygenCompressor(InventoryPlayer par1InventoryPlayer,
            TileEntityOxygenCompressor par2TileEntityAirDistributor) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        status = GCCoreUtil.translate("gui.oxygenUse.desc") + ": "
                + TileEntityOxygenCompressor.TANK_TRANSFER_SPEED * 20
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        if (this.compressor != null) {
            ...
            EnergyDisplayHelper.getEnergyDisplayTooltip(
                    this.compressor.getEnergyStoredGC(),
                    this.compressor.getMaxEnergyStoredGC(),
                    electricityDesc);

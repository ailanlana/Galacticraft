...
public class OverlaySensorGlasses extends Overlay {
    private static final ResourceLocation hudTexture =
            new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/gui/hud.png");
    ...
    public static void renderSensorGlassesValueableBlocks(
        ...
        while (var51.hasNext()) {
            ...
            final EntityClientPlayerMP client =
            ...
            OverlaySensorGlasses.minecraft.fontRenderer.drawString(
                    GCCoreUtil.translate("gui.sensor.advanced") + ": "
                            + (var2
                                    ? GCCoreUtil.translate("gui.sensor.advancedon")
            ...
            try {
                ...
                if (var20 < 4.0D) {
                    GL11.glColor4f(0.0F, 255F / 255F, 198F / 255F, (float)
                            Math.min(1.0D, Math.max(0.2D, (var20 - 1.0D) * 0.1D)));

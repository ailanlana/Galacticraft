...
public class OverlayLander extends Overlay {
    ...
    public static void renderLanderOverlay() {
        ...
        final ScaledResolution scaledresolution = ClientUtil.getScaledRes(
                minecraft, OverlayLander.minecraft.displayWidth, OverlayLander.minecraft.displayHeight);
        ...
        if (OverlayLander.minecraft.thePlayer.ridingEntity.motionY < -2.0) {
            OverlayLander.minecraft.fontRenderer.drawString(
                    ...
                    width / 4
                            - OverlayLander.minecraft.fontRenderer.getStringWidth(GCCoreUtil.translate("gui.warning"))
                                    / 2,
                    height / 8 - 20,
            ...
            OverlayLander.minecraft.fontRenderer.drawString(
                    ...
                    width / 4
                            - OverlayLander.minecraft.fontRenderer.getStringWidth(press1

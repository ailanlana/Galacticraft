...
public class TileEntityTreasureChestRenderer extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation treasureLargeChestTexture =
            new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/model/treasurelarge.png");
    ...
    public void renderGCTileEntityTreasureChestAt(
            TileEntityTreasureChest par1GCTileEntityTreasureChest, double par2, double par4, double par6, float par8) {
        int var9;

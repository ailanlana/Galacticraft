...
public interface IGameScreen {
    /**
     * Set up the frame edge size for this screen. This part must not be drawn when
     ...
     * (0, 0, 0) - (scaleX, scaleY, 0)
     * <p>
     * Register your IGameScreen by calling DrawGameScreen.registerScreen(); from
     * your @Mod class during Forge postInit() phase.
     *
     ...
     *               <p>
     *               NOTE 1: It is not necessary to enclose your code with
     *               glPushMatrix and glPopMatrix, as this will be done by the
     *               calling method. You can also change the lighting in your render
     *               as the calling method will finish by calling

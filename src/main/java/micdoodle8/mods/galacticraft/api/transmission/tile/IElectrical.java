...
public interface IElectrical extends IConnector {
    /**
     * Adds electricity to an block. Returns the quantity of electricity that was
     * accepted. This should always return 0 if the block cannot be externally
     * charged.
     *
     ...
     * @param tierProduced The tier of electricity which is being provided (must be
     *                     1 or 2)
     ...
     * provided. This should always return null if the block cannot be externally
     * discharged.
     *

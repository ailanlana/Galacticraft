...
public interface ITerraformableBlock {
    /**
     * Determines if the block as this position is terraformable. This will only be
     * called for blocks inside the terraformer bubble. It is recommended that you
     * test whether the block can see the surface before returning true.
     *

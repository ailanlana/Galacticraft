...
public class RecipeManagerMars {
    ...
    private static void addUniversalRecipes() {
        ...
        RecipeUtil.addRecipe(
                new ItemStack(MarsBlocks.marsBlock, 1, 8), new Object[] {"XXX", "XXX", "XXX", 'X', deshIngot});

        RecipeUtil.addRecipe(new ItemStack(MarsBlocks.machine, 1, 0), new Object[] {
            "XWX",
            "XZX",
            "WVW",
            'V',
            ...
            deshIngot,
            'Z',
            new ItemStack(GCItems.canister)
        });

        RecipeUtil.addRecipe(new ItemStack(MarsBlocks.machine, 1, 4), new Object[] {
            "XYX", "XZX", "XYX", 'X', deshPlate, 'Y', new ItemStack(MarsItems.marsItemBasic, 1, 3), 'Z', Items.bed
        });
        // Gas liquefier
        RecipeUtil.addRecipe(new ItemStack(MarsBlocks.machineT2, 1, 0), new Object[] {
            "TVS",
            "FWS",
            "PXO",
            'T',
            ...
            GCItems.oxygenVent,
            'F',
            new ItemStack(GCBlocks.oxygenPipe, 1, 0),
            'X',
        ...
        // Methane Synthesizer
        RecipeUtil.addRecipe(new ItemStack(MarsBlocks.machineT2, 1, 4), new Object[] {
            "TVT",
            "FWF",
            "CXO",
            'T',
        ...
        // Water Electrolyzer
        RecipeUtil.addRecipe(new ItemStack(MarsBlocks.machineT2, 1, 8), new Object[] {
            "TVT",
            "FWF",
            "BXB",
            'T',
        ...
        RecipeUtil.addRecipe(new ItemStack(MarsItems.marsItemBasic, 1, 6), new Object[] {
            "MXM",
            "SWS",
            "MXM",
            'S',
        ...
        RecipeUtil.addRecipe(
                new ItemStack(MarsBlocks.hydrogenPipe, 6, 0), new Object[] {"CCC", "   ", "CCC", 'C', "ingotCopper"});

        RecipeUtil.addRecipe(new ItemStack(MarsItems.marsItemBasic, 1, 1), new Object[] {"X", "X", 'X', deshIngot});

        RecipeUtil.addRecipe(new ItemStack(MarsItems.marsItemBasic, 1, 4), new Object[] {
            "XWX", "XYX", " Z ", 'W', Items.diamond, 'X', Items.leather, 'Y', Items.slime_ball, 'Z', Blocks.chest
        });

        RecipeUtil.addRecipe(new ItemStack(MarsItems.deshSword), new Object[] {
            "X",
            "X",
            "Y",
            'X',
        ...
        RecipeUtil.addRecipe(new ItemStack(MarsItems.deshPickaxe), new Object[] {
            "XXX",
            " Y ",
            " Y ",
            'X',
        ...
        RecipeUtil.addRecipe(new ItemStack(MarsItems.deshSpade), new Object[] {
            "X",
            "Y",
            "Y",
            'X',
        ...
        RecipeUtil.addRecipe(new ItemStack(MarsItems.deshHoe), new Object[] {
            "XX",
            "Y ",
            "Y ",
            'X',
        ...
        RecipeUtil.addRecipe(new ItemStack(MarsItems.deshAxe), new Object[] {
            "XX",
            "XY",
            " Y",
            'X',
        ...
        FurnaceRecipes.smelting()
                .func_151394_a(
                        new ItemStack(MarsBlocks.marsBlock, 1, 4), new ItemStack(MarsBlocks.marsBlock, 1, 9), 0.0F);
        FurnaceRecipes.smelting()
        ...
        FurnaceRecipes.smelting()
                .func_151394_a(
                        new ItemStack(MarsBlocks.marsBlock, 1, 2), new ItemStack(MarsItems.marsItemBasic, 1, 2), 0.2F);
        FurnaceRecipes.smelting()
         ...
         * ItemStack(MarsItems.marsItemBasic, 1, 3)); input.put(4, new
         * ItemStack(MarsItems.marsItemBasic, 1, 3)); input.put(5, new
         * ItemStack(MarsItems.marsItemBasic, 1, 3)); input.put(6, new
         * ItemStack(MarsItems.marsItemBasic, 1, 3)); input.put(7, new
         * ItemStack(MarsItems.marsItemBasic, 1, 3)); input.put(8, new
         * ItemStack(MarsItems.marsItemBasic, 1, 3)); input.put(9, new
         * ItemStack(MarsItems.marsItemBasic, 1, 3)); input.put(10, new
         * ItemStack(MarsItems.marsItemBasic, 1, 3)); input.put(11, new
         * ItemStack(MarsItems.marsItemBasic, 1, 3)); input.put(12, new
         ...
         * input.put(15, new ItemStack(GCItems.rocketEngine)); input.put(16, new
         * ItemStack(GCItems.rocketEngine, 1, 1)); input.put(17, new
         * ItemStack(GCItems.partFins)); input.put(18, new ItemStack(GCItems.partFins));
         * input.put(19, null); input.put(20, null); input.put(21, null);
         * MarsUtil.addRocketBenchT2Recipe(new ItemStack(MarsItems.spaceship, 1, 0),
         * input);
         */

        HashMap<Integer, ItemStack> input2 = new HashMap<>(input); /*
         * input2.put(19, new ItemStack(Blocks.chest)); input2.put(20, null);
         * input2.put(21, null); MarsUtil.addRocketBenchT2Recipe(new
         * ItemStack(MarsItems.spaceship, 1, 1), input2);
         *
         * input2 = new HashMap<Integer, ItemStack>(input); input2.put(19, null);
         * input2.put(20, new ItemStack(Blocks.chest)); input2.put(21, null);
         * MarsUtil.addRocketBenchT2Recipe(new ItemStack(MarsItems.spaceship, 1, 1),
         * input2);
         *
         * input2 = new HashMap<Integer, ItemStack>(input); input2.put(19, null);
         ...
         * input2.put(21, null); MarsUtil.addRocketBenchT2Recipe(new
         * ItemStack(MarsItems.spaceship, 1, 2), input2);
         *
         * input2 = new HashMap<Integer, ItemStack>(input); input2.put(19, new
         * ItemStack(Blocks.chest)); input2.put(20, null); input2.put(21, new
         * ItemStack(Blocks.chest)); MarsUtil.addRocketBenchT2Recipe(new
         * ItemStack(MarsItems.spaceship, 1, 2), input2);
         *
         * input2 = new HashMap<Integer, ItemStack>(input); input2.put(19, null);
         ...
         * MarsUtil.addRocketBenchT2Recipe(new ItemStack(MarsItems.spaceship, 1, 3),
         * input2);
         */
        ...
        RecipeUtil.addRecipe(
                new ItemStack(MarsBlocks.machine, 1, BlockMachineMars.LAUNCH_CONTROLLER_METADATA), new Object[] {
                    "ZVZ",
                    "YXY",
                    "ZWZ",
                    'V',

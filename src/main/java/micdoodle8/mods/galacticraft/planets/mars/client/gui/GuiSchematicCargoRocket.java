...
public class GuiSchematicCargoRocket extends GuiContainer implements ISchematicResultPage {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        this.fontRendererObj.drawString(
                EnumColor.WHITE + GCCoreUtil.translate("item.spaceshipTier2.cargoRocket.name"), 7, 7, 0x404040);
        this.fontRendererObj.drawString(
                EnumColor.WHITE + GCCoreUtil.translate("container.inventory"), 14, 128, 0x404040);
    }

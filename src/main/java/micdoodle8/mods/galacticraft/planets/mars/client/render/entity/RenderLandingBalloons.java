...
public class RenderLandingBalloons extends Render {
    private static final ResourceLocation landerTexture =
            new ResourceLocation(MarsModule.ASSET_PREFIX, "textures/model/landingBalloon.png");
    ...
    public RenderLandingBalloons() {
        ...
        this.landerModel = AdvancedModelLoader.loadModel(
                new ResourceLocation(MarsModule.ASSET_PREFIX, "models/landingBalloon.obj"));
    }
    ...
    public void renderLander(
            EntityLandingBalloons entity, double par2, double par4, double par6, float par8, float par9) {
        GL11.glPushMatrix();

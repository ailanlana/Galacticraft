...
public class BlockTier2TreasureChest extends BlockContainer
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, Block par5) {
        ...
        final TileEntityTreasureChestMars var6 =
                (TileEntityTreasureChestMars) par1World.getTileEntity(par2, par3, par4);
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6) {
        final TileEntityTreasureChestMars var7 =
                (TileEntityTreasureChestMars) par1World.getTileEntity(par2, par3, par4);
    ...
    public boolean onBlockActivated(
        ...
        if (var10 == null) {
            ...
            if (par1World.getBlock(par2 + 1, par3, par4) == this) {
                var10 = new InventoryLargeChest(
                        "container.chestDouble", (IInventory) var10, (TileEntityTreasureChestMars)

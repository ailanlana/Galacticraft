...
public class GuiLaunchController extends GuiContainerGC
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.enableControllerButton.displayString = this.launchController.getDisabled(0)
                ? GCCoreUtil.translate("gui.button.enable.name")
                : GCCoreUtil.translate("gui.button.disable.name");
        this.hideDestinationFrequency.displayString = !this.launchController.getDisabled(2)
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (this.cannotEditTimer > 0) {
            this.fontRendererObj.drawString(
                    this.launchController.getOwnerName(),
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        EnergyDisplayHelper.getEnergyDisplayTooltip(
                ...
                this.launchController.getMaxEnergyStoredGC(),
                electricityDesc);

...
public class TileEntityTreasureChestRenderer extends TileEntitySpecialRenderer {
    private static final ResourceLocation treasureChestTexture =
            new ResourceLocation(MarsModule.ASSET_PREFIX, "textures/model/treasure.png");
    private static final ResourceLocation treasureLargeChestTexture =
            new ResourceLocation(MarsModule.ASSET_PREFIX, "textures/model/treasurelarge.png");
    ...
    public void renderGCTileEntityTreasureChestAt(
            TileEntityTreasureChestMars par1GCTileEntityTreasureChest,
            double par2,
            double par4,
            double par6,
            float par8) {
